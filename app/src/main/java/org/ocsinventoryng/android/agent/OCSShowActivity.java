...
import org.ocsinventoryng.android.agent.util.SystemUiHider;

/**
 * An example full-screen activity that shows and hides the system UI (i.e. status bar and navigation/system bar) with user
 * interaction.
 *
 * @see SystemUiHider
 */
public class OCSShowActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ocs_show);
        ...
        Inventory inv = Inventory.getInstance(this);
        ((EditText) findViewById(R.id.textShow)).setText(inv.toString());
    }
    ...
    /**
     * Touch listener to use for in-layout UI controls to delay hiding the system UI. This is to prevent the jarring behavior of
     * controls going away while interacting with activity UI.
     */
