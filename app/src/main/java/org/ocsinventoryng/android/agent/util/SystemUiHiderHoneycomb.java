...
/**
 * An API 11+ implementation of {@link SystemUiHider}. Uses APIs available in Honeycomb and later (specifically {@link
 * View#setSystemUiVisibility(int)}) to show and hide the system UI.
 */
